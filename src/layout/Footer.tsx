...
const Footer = () => {
  return (
    <div
      className=" bg-[#14274A] h-52 flex items-center justify-between   w-full"
      id="footer"
    >
      <div className=" container mx-auto px-10 flex items-center justify-around text-white">
        {" "}
        <div className="w-[17%] space-y-3">
          <ul className="flex flex-col w-fit items-center justify-center cursor-pointer">
        ...
        <div>
          <ul className="space-y-2">
            <li className="flex gap-x-4 cursor-pointer">
        ...
        <div className="space-y-5">
          ...
          <div className="flex h-9">
            ...
            />
            <div className="px-3 bg-[#E0B973] flex items-center text-[#14274A] font-bold uppercase rounded-tr-md rounded-br-md cursor-pointer">
              ok
            </div>
          </div>
        </div>
